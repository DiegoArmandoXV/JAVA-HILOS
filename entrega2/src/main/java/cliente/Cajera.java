...
public class Cajera extends Thread {
    ...
    public void cobrar(Cliente cliente) {
        ...
        synchronized (cliente) {
            ...
            System.out.println("La Cajera con id: " + id + " está cobrando al Cliente " + cliente.getId());

            for (Producto producto : cliente.getProductos()) {
                System.out.println("La Cajera con id: " + id + " está procesando el producto: " + producto.getNombre());
